        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
            <li class="nav-item dropdown dropdown-language">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-flag">
                    <a class="dropdown-item" href="{{ route('changeLanguage', ['locale' => 'en']) }}" data-language="en">
                        <i class="flag-icon flag-icon-us"></i> English</a>
                    <a class="dropdown-item" href="{{ route('changeLanguage', ['locale' => 'ar']) }}" data-language="ar">
            ...
            <li class="nav-item dropdown dropdown-user">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
                    ...
                    <a class="dropdown-item" onclick="$('#logout-form').submit()" href="#"><i class="mr-50" data-feather="power"></i> Logout</a>
